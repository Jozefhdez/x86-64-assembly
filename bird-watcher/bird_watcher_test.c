...
void test_last_week_default(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(
        exp_buffer_last, actual_buffer_last,
        "Counts for last week are different than expected.");
}
...
void test_current_week_default(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(
        exp_buffer_current, actual_buffer_current,
        "Counts for the week are different than expected.");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        0, crt.length, "The number of counts is different than expected.");
}
...
void test_save_count_first_day(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(
        ...
        "Counts for the week are different than expected.");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        1, crt.length, "The number of counts is different than expected.");
}

void test_today_count_first_entry(void) {
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        5, actual, "Today's count is different than expected.");
}
...
void test_update_today_count_first_entry(void) {
    ...
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        7, actual, "Today's count is different than expected.");
}
...
void test_save_count_finish_week(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(
        ...
        "Counts for the week are different than expected.");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        7, crt.length, "The number of counts is different than expected.");
}

void test_today_count_current_week(void) {
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        42, actual, "Today's count is different than expected.");
}
...
void test_update_today_count_current_week(void) {
    ...
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        56, actual, "Today's count is different than expected.");
}
...
void test_today_count_new_week(void) {
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        12, actual, "Today's count is different than expected.");
}
...
void test_update_today_count_new_week(void) {
    ...
    const uint8_t actual = today_count();
    TEST_ASSERT_EQUAL_UINT8_MESSAGE(
        41, actual, "Today's count is different than expected.");
}
...
void test_continuous_save_count(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(
        ...
        "Counts for the week are different than expected.");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        5, crt.length, "The number of counts is different than expected.");
}
