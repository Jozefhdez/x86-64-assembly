...
void test_value_of_card_2(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: C2.");
}
...
void test_value_of_card_5(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: C5.");
}
...
void test_value_of_card_a(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: CA.");
}
...
void test_value_of_card_j(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: CJ.");
}
...
void test_value_of_card_8(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: C8.");
}
...
void test_value_of_card_k(void) {
    ...
    const uint64_t expected = 10;
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: CK.");
}
...
void test_value_of_card_q(void) {
    ...
    const uint64_t expected = 10;
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with argument: CQ.");
}
...
void test_higher_card_4_8(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        ...
        "Mismatch on the higher card. The function was called with arguments: "
        "C4, C8.");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected.snd, actual.snd,
        "The second value should be 0. The function was called with arguments: "
        "C4, C8.");
}
...
void test_higher_card_a_a(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected.snd, actual.snd,
        "Mismatch on the second higher card. The function was called with "
        "arguments: CA, CA.");
}
...
void test_value_of_ace_2_3(void) {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: C2, C3.");
}
...
void test_value_of_ace_a_q(void) {
    ...
    const uint64_t actual = value_of_ace(card_one, card_two);
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: CA, CQ.");
}
...
void test_value_of_ace_5_5(void) {
    ...
    const uint64_t actual = value_of_ace(card_one, card_two);
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: C5, C5.");
}
...
void test_value_of_ace_a_2(void) {
    ...
    const uint64_t actual = value_of_ace(card_one, card_two);
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: CA, C2.");
}
...
void test_value_of_ace_7_3(void) {
    ...
    const uint64_t actual = value_of_ace(card_one, card_two);
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: C7, C3.");
}
...
void test_value_of_ace_7_4(void) {
    ...
    const uint64_t actual = value_of_ace(card_one, card_two);
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(
        expected, actual, "The function was called with arguments: C7, C4.");
}
...
void test_is_blackjack_a_k(void) {
    ...
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CA, CK.");
}
...
void test_is_blackjack_a_a(void) {
    ...
    const bool actual = is_blackjack(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CA, CA.");
}
...
void test_is_blackjack_4_7(void) {
    ...
    const bool actual = is_blackjack(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C4, C7.");
}
...
void test_is_blackjack_q_k(void) {
    ...
    const bool actual = is_blackjack(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CQ, CK.");
}
...
void test_is_blackjack_a_10(void) {
    ...
    const bool actual = is_blackjack(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CA, C10.");
}
...
void test_is_blackjack_j_a(void) {
    ...
    const bool actual = is_blackjack(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CJ, CA.");
}
...
void test_can_split_10_a(void) {
    ...
    const bool actual = can_split_pairs(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C10, CA.");
}
...
void test_can_split_6_6(void) {
    ...
    const bool actual = can_split_pairs(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C6, C6.");
}
...
void test_can_split_9_10(void) {
    ...
    const bool actual = can_split_pairs(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C9, C10.");
}
...
void test_can_split_10_k(void) {
    ...
    const bool actual = can_split_pairs(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C10, CK.");
}
...
void test_can_double_down_a_9(void) {
    ...
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CA, C9.");
}
...
void test_can_double_down_k_j(void) {
    ...
    const bool actual = can_double_down(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CK, CJ.");
}
...
void test_can_double_down_4_3(void) {
    ...
    const bool actual = can_double_down(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C4, C3.");
}
...
void test_can_double_down_4_5(void) {
    ...
    const bool actual = can_double_down(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: C4, C5.");
}
...
void test_can_double_down_k_a(void) {
    ...
    const bool actual = can_double_down(card_one, card_two);
    TEST_ASSERT_EQUAL_MESSAGE(
        expected, actual, "The function was called with arguments: CK, CA.");
}
