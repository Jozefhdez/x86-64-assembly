...
void test_front_door_response_s1(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "S", &actual, 1, "Passed line: Sunshine warming my toes,");
}

void test_front_door_response_u1(void) {
    const char actual = front_door_response("Underwater fun with my friends.");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "U", &actual, 1, "Passed line: Underwater fun with my friends.");
}

void test_front_door_response_m1(void) {
    const char actual =
        front_door_response("Making homemade ice cream on the porch,");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "M", &actual, 1,
...
void test_front_door_response_m2(void) {
    const char actual =
        front_door_response("Many long nights catching fireflies.");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "M", &actual, 1, "Passed line: Many long nights catching fireflies.");
}

void test_front_door_response_e1(void) {
    const char actual =
        front_door_response("Early morning walks to the creek,");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "E", &actual, 1, "Passed line: Early morning walks to the creek,");
}

void test_front_door_response_r1(void) {
    const char actual =
        front_door_response("Reveling in the freedom of lazy days.");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "R", &actual, 1, "Passed line: Reveling in the freedom of lazy days.");
}

void test_front_door_response_s2(void) {
    const char actual = front_door_response("Serene, calming quality");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "S", &actual, 1, "Passed line: Serene, calming quality");
}

void test_front_door_response_o1(void) {
    const char actual =
        front_door_response("Organized, you always have it together");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "O", &actual, 1, "Passed line: Organized, you always have it together");
}

void test_front_door_response_p1(void) {
    const char actual =
        front_door_response("Picturesque, strikingly beautiful");
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "P", &actual, 1, "Passed line: Picturesque, strikingly beautiful");
}
...
void test_front_door_response_d1(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(
        "D", &actual, 1, "Passed line: Different processes ajar");
}
...
void test_back_door_password_work(void) {
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE("Work, please.", buffer,
                                     "Combined letters are: work");
}
...
void test_back_door_password_horse(void) {
    ...
    char letters[] = "horse";
    back_door_password(buffer, letters);
    TEST_ASSERT_EQUAL_STRING_MESSAGE("Horse, please.", buffer,
                                     "Combined letters are: horse");
}
